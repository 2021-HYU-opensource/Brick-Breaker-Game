...
class brickbreaker():
    ...
    def init_game(self):
        ...
        self.ball = pygame.Rect(365, paddley - ball_diameter, ball_diameter,
                                ball_diameter)  # ball approximated to the rect object
    ...
    def run(self):
        ...
        while True:
            ...
            # Draw the ball
            pygame.draw.circle(self.screen, pink, (self.ball.left + ball_radius, self.ball.top + ball_radius),
                               ball_radius)
